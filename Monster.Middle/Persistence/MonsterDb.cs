...
namespace Monster.Middle.Persistence
{
    ...
    public interface IMonsterDataContext : System.IDisposable
    {
        ...
        System.Data.Entity.DbSet<UsrTenantEntry> UsrTenantEntries { get; set; } // usrTenantEntry
    ...
    public class MonsterDataContext : System.Data.Entity.DbContext, IMonsterDataContext
    {
        ...
        public System.Data.Entity.DbSet<UsrTenantEntry> UsrTenantEntries { get; set; } // usrTenantEntry
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new UsrTenantEntryConfiguration());
        }
        ...
        public static System.Data.Entity.DbModelBuilder CreateModel(System.Data.Entity.DbModelBuilder modelBuilder, string schema)
        {
            ...
            modelBuilder.Configurations.Add(new UsrTenantEntryConfiguration(schema));
            return modelBuilder;
        }
    }
    #endregion
    ...
    public class FakeMonsterDataContext : IMonsterDataContext
    {
        ...
        public System.Data.Entity.DbSet<UsrTenantEntry> UsrTenantEntries { get; set; }
        ...
        public FakeMonsterDataContext()
        {
            ...
            UsrTenantEntries = new FakeDbSet<UsrTenantEntry>("TenantId");
        }
    ...
    // usrTenantEntry
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class UsrTenantEntry
    {
        public long TenantId { get; set; } // TenantId (Primary key)
        public string Connection { get; set; } // Connection (length: 500)
    ...
    // usrTenantEntry
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class UsrTenantEntryConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UsrTenantEntry>
    {
        public UsrTenantEntryConfiguration()
            : this("dbo")
        {
        }

        public UsrTenantEntryConfiguration(string schema)
        {
            ToTable("usrTenantEntry", schema);
            HasKey(x => x.TenantId);

            Property(x => x.TenantId).HasColumnName(@"TenantId").HasColumnType("bigint").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.Connection).HasColumnName(@"Connection").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(500);
